...
class CustomStrategy(IStrategy):
    ...
    def populate_buy_trend(self, dataframe: DataFrame) -> DataFrame:
        ...
        dataframe.loc[
           (
               qtpylib.crossed_above(dataframe['volume'] ,dataframe['volume'].mean() + 1.1*dataframe['volume'].std())
               &
    ...
    def populate_sell_trend(self, dataframe: DataFrame) -> DataFrame:
        ...
        dataframe.loc[
           (
               qtpylib.crossed_below(dataframe['volume'] , dataframe['volume'].mean() + 1.1*dataframe['volume'].std())
           )
           , 'sell'] = 1
        return dataframe
